...
type Props = {
  ...
  strokeColor: string
  chartHeight: string
  kbPerResolvedIssue: number
}

const KbRequestResolved: React.FC<Props> = ({ className, chartColor, chartHeight, strokeColor, kbPerResolvedIssue }) => {
  ...
  return (
    <div className='col mixedwidget2-bodycolor px-4 py-4 rounded-2 me-7 mb-7 tc-width'>
      ...
      <a href='#' className='text-white fw fs-4'>
        Total Request Resolved KBs {Month} : <b>{kbPerResolvedIssue[0].IssueResolveCount}</b>
      </a>
    </div>
  )
}
