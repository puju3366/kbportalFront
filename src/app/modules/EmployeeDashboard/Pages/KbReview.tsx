...
type Props = {
  ...
  strokeColor: string
  chartHeight: string
  unreviewedKbCount: number
}

const KbReview: React.FC<Props> = ({ className, chartColor, chartHeight, strokeColor, unreviewedKbCount }) => {
  ...
  return (
    <div className='col mixedwidget2-bodycolor px-4 py-4 rounded-2 me-7 mb-7 tc-width'>
      ...
      <a href='#' className='text-white fw fs-4'>
        Total Unreviewed KBs {Month} : <b>{unreviewedKbCount[0].Un_Reviewed_KB_count}</b>
      </a>
    </div>
  )
}
